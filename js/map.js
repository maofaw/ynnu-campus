...
function planRoute(mode, routeIdx) {
  ...
  function onComplete(type, routeObj, result) {
    ...
    lastRouteIdx = (typeof routeIdx === 'number' && lastRouteAlts[routeIdx]) ? routeIdx : 0;
    const r = lastRouteAlts[lastRouteIdx] || lastRouteAlts[0];
